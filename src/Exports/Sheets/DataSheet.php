 ...
 *
 * Tiap kolom pilihan punya sheet referensinya sendiri, bernama sama dengan
 * kolomnya — komentar di bawah menyebutkan yang mana.
 */
class DataSheet implements FromArray, WithHeadings, WithTitle
{
    ...
    public function headings(): array
    {
        ...
        return [
            ...
            'Tahun',                       // 1
            'Peruntukan',                  // 2  lihat sheet "Peruntukan"
            'Pengusul',                    // 3
            'Dapil DPRD',                  // 4
            ...
            'Bentuk',                      // 9  lihat sheet "Bentuk"
            'Nama OPD',                    // 10 kode ATAU nama — lihat sheet "Nama OPD"
            'Program',                     // 11
            'Kegiatan',                    // 12
            'Sub Kegiatan',                // 13
            ...
            'Jenis Penerima',              // 18 lihat sheet "Jenis Penerima"
            'Realisasi TW I',              // 19
            'Realisasi TW II',             // 20
            'Realisasi TW III',            // 21
            'Realisasi TW IV',             // 22
            ...
            'Keterangan',                  // 26
            'Jenis BK',                    // 27 hanya untuk BK — lihat sheet "Jenis BK"
        ];
    }
